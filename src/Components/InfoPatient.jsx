  ...
  return (
    <div className="flex flex-col items-center bg-FFFFFF w-[30vw] rounded-xl border-E3E3E3">
      ...
      <div className="relative mt-[1vh]">
        ...
        <img src={Upload} alt="Icon" className="absolute right-5 top-3 w-6 h-6"/>
      </div>
      <div className="flex mt-[1vh] mb-[1vh] pr-[65%]">
        <input type="checkbox" className="form-checkbox border-blue-500" />
