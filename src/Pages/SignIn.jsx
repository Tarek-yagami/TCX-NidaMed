  ...
  return (
    <div className='flex flex-row justify-center '>
        <div className='flex flex-col gap-[2vh] px-[5%] py-[0.5%]  '>
            ...
            <InputBar Data='Nom Complet' DataPlaceholder='Nom'/>
            <InputBar Data='Email' DataPlaceholder='Adresse email'/>
            <div className='flex flex-col gap-[1vh]'>
                <h3 className='text-[2rem] font-medium text-BlueDark'>Mot de passe</h3>
                <input  type="password" placeholder='Mot de passe' className='py-[2.5vh] w-[37vw] pl-[2vw] rounded-xl text-[2rem] border   placeholder-Blue opacity-70'/>
            </div>
